...
static const struct gd32_uart uart_obj[] = {
    ...
    {USART2,                           // uart peripheral index
     ...
     RCU_USART2, RCU_GPIOC, RCU_GPIOC, // periph clock, tx gpio clock, rt gpio clock
#if defined SOC_SERIES_GD32F4xx
...
#else
        GPIOC,
        GPIO_PIN_12, // tx port, tx pin
        GPIOD,
        GPIO_PIN_2, // rx port, rx pin
#endif
     &serial4,
     "uart4",
#ifdef RT_SERIAL_USING_DMA
...
#else
        GPIOC,
        GPIO_PIN_6, // tx port, tx pin
        GPIOC,
        GPIO_PIN_7, // rx port, rx pin
#endif
     &serial5,
     "uart5",
#ifdef RT_SERIAL_USING_DMA
...
#else
        GPIOE,
        GPIO_PIN_7, // tx port, tx pin
        GPIOE,
        GPIO_PIN_8, // rx port, rx pin
#endif
     &serial6,
     "uart6",
#ifdef RT_SERIAL_USING_DMA
...
#else
        GPIOE,
        GPIO_PIN_0, // tx port, tx pin
        GPIOE,
        GPIO_PIN_1, // rx port, rx pin
#endif
     &serial7,
     "uart7",
#ifdef RT_SERIAL_USING_DMA
